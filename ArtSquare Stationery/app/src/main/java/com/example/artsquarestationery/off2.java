...
public class off2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemname = findViewById(R.id.itemname23);
        cost = findViewById(R.id.cost23);
    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userprofile!=null){
                    ...
                    FirebaseDatabase.getInstance().getReference("Favourites")
                            .child("w").setValue(fav);
                    Toast.makeText(off2.this,"Item Added to Favourites Successfully",Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(off2.this, "Something went Wrong..", Toast.LENGTH_LONG).show();
            }
        });
    }

    public void buyoff2(View view) {
        ...
        if(q!=0){
            ...
            if(totalprice<2000){
                ...
                Intent billing = new Intent(off2.this,customer_billing.class);
