...
public class n3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemname = findViewById(R.id.itemname19);
        cost = findViewById(R.id.cost19);
    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userprofile!=null){
                    ...
                    FirebaseDatabase.getInstance().getReference("Favourites")
                            .child("s").setValue(fav);
                    Toast.makeText(n3.this,"Item Added to Favourites Successfully",Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(n3.this, "Something went Wrong..", Toast.LENGTH_LONG).show();
            }
        });
    }

    public void buyn3(View view) {
        ...
        if(q!=0){
            ...
            if(totalprice<1000){
                ...
                Intent billing = new Intent(n3.this,customer_billing.class);
