...
public class n5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemname = findViewById(R.id.itemname21);
        cost = findViewById(R.id.cost21);
    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userprofile!=null){
                    ...
                    FirebaseDatabase.getInstance().getReference("Favourites")
                            .child("u").setValue(fav);
                    Toast.makeText(n5.this,"Item Added to Favourites Successfully",Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(n5.this, "Something went Wrong..", Toast.LENGTH_LONG).show();
            }
        });
    }

    public void buyn5(View view) {
        ...
        if(q!=0){
            ...
            if(totalprice<500){
                ...
                Intent billing = new Intent(n5.this,customer_billing.class);
