...
public class engg5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_engg5);

        value=(TextView) findViewById(R.id.value);
        itemname = findViewById(R.id.itemname11);
        cost = findViewById(R.id.cost11);
    }
    ...
    public void favengg5(View view) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userprofile!=null){
                    ...
                    FirebaseDatabase.getInstance().getReference("Favourites")
                            .child("k").setValue(fav);
                    Toast.makeText(engg5.this,"Item Added to Favourites Successfully",Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(engg5.this, "Something went Wrong..", Toast.LENGTH_LONG).show();
            }
        });
    }

    public void buyengg5(View view) {
        ...
        if(q!=0){
            ...
            if(totalprice<2000){
                ...
                Intent billing = new Intent(engg5.this,customer_billing.class);
