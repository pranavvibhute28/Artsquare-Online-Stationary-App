...
public class engg1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_engg1);

        value=(TextView) findViewById(R.id.value);
        itemname = findViewById(R.id.itemname7);
    ...
    public void favengg1(View view) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userprofile!=null){
                    ...
                    FirebaseDatabase.getInstance().getReference("Favourites")
                            .child("a").setValue(fav);
                    Toast.makeText(engg1.this,"Item Added to Favourites Successfully",Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(engg1.this, "Something went Wrong..", Toast.LENGTH_LONG).show();
            }
        });
    }

    public void buyengg1(View view) {
        ...
        if(q!=0){
            ...
            if(totalprice<2000){
                ...
                Intent billing = new Intent(engg1.this,customer_billing.class);
