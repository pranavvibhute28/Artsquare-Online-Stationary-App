            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userprofile!=null){
                    ...
                    FirebaseDatabase.getInstance().getReference("Favourites")
                            .child("c").setValue(fav);
                    Toast.makeText(art1.this,"Item Added to Favourites Successfully",Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(art1.this, "Something went Wrong..", Toast.LENGTH_LONG).show();
            }
        });
    }

    public void buyart1(View view) {
        ...
        if(q!=0){
            ...
            if(totalprice<2500){
                ...
                Intent billing = new Intent(art1.this,customer_billing.class);
