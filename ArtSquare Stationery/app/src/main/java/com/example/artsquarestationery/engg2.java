...
public class engg2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_engg2);

        value=(TextView) findViewById(R.id.value);
        itemname = findViewById(R.id.itemname8);
    ...
    public void favengg2(View view) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userprofile!=null){
                    ...
                    FirebaseDatabase.getInstance().getReference("Favourites")
                            .child("h").setValue(fav);
                    Toast.makeText(engg2.this,"Item Added to Favourites Successfully",Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(engg2.this, "Something went Wrong..", Toast.LENGTH_LONG).show();
            }
        });
    }

    public void buyengg2(View view) {
        ...
        if(q!=0){
            ...
            if(totalprice<2000){
                ...
                Intent billing = new Intent(engg2.this,customer_billing.class);
