...
public class engg4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_engg4);

        value=(TextView) findViewById(R.id.value);
        itemname = findViewById(R.id.itemname10);
        cost = findViewById(R.id.cost10);
    }
    ...
    public void favengg4(View view) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userprofile!=null){
                    ...
                    FirebaseDatabase.getInstance().getReference("Favourites")
                            .child("j").setValue(fav);
                    Toast.makeText(engg4.this,"Item Added to Favourites Successfully",Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(engg4.this, "Something went Wrong..", Toast.LENGTH_LONG).show();
            }
        });
    }

    public void buyengg4(View view) {
        ...
        if(q!=0){
            ...
            if(totalprice<1500){
                Toast.makeText(this,"Total cost should be more than the limit : 1500",Toast.LENGTH_LONG).show();
            }
            else{
                Intent billing = new Intent(engg4.this,customer_billing.class);
                ...
                billing.putExtra("pricelimit",String.valueOf(1500));
