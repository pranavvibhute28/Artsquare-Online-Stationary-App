...
public class gen2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemname = findViewById(R.id.itemname13);
        cost = findViewById(R.id.cost13);
    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userprofile!=null){
                    ...
                    FirebaseDatabase.getInstance().getReference("Favourites")
                            .child("m").setValue(fav);
                    Toast.makeText(gen2.this,"Item Added to Favourites Successfully",Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(gen2.this, "Something went Wrong..", Toast.LENGTH_LONG).show();
            }
        });
    }

    public void buygen2(View view) {
        ...
        if(q!=0){
            ...
            if(totalprice<500){
                Toast.makeText(this,"Total cost should be more than the limit : 500",Toast.LENGTH_LONG).show();
            }
            else{
                Intent billing = new Intent(gen2.this,customer_billing.class);
                ...
                billing.putExtra("pricelimit",String.valueOf(500));
