...
public class art4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemname = findViewById(R.id.itemname4);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userprofile!=null){
                    ...
                    FirebaseDatabase.getInstance().getReference("Favourites")
                            .child("f").setValue(fav);
                    Toast.makeText(art4.this,"Item Added to Favourites Successfully",Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(art4.this, "Something went Wrong..", Toast.LENGTH_LONG).show();
            }
        });
    }

    public void buyart4(View view) {
        ...
        if(q!=0){
            ...
            if(totalprice<2000){
                ...
                Intent billing = new Intent(art4.this,customer_billing.class);
