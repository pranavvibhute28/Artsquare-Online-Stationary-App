...
public class gen1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemname = findViewById(R.id.itemname12);
        cost = findViewById(R.id.cost12);
    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userprofile!=null){
                    ...
                    FirebaseDatabase.getInstance().getReference("Favourites")
                            .child("l").setValue(fav);
                    Toast.makeText(gen1.this,"Item Added to Favourites Successfully",Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(gen1.this, "Something went Wrong..", Toast.LENGTH_LONG).show();
            }
        });
    }

    public void buygen1(View view) {
        ...
        if(q!=0){
            ...
            if(totalprice<1000){
                ...
                Intent billing = new Intent(gen1.this,customer_billing.class);
