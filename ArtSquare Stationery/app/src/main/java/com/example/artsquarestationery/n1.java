...
public class n1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemname = findViewById(R.id.itemname17);
        cost = findViewById(R.id.cost17);
    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userprofile!=null){
                    ...
                    FirebaseDatabase.getInstance().getReference("Favourites")
                            .child("q").setValue(fav);
                    Toast.makeText(n1.this,"Item Added to Favourites Successfully",Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(n1.this, "Something went Wrong..", Toast.LENGTH_LONG).show();
            }
        });
    }

    public void buyn1(View view) {
        ...
        if(q!=0){
            ...
            if(totalprice<750){
                Toast.makeText(this,"Total cost should be more than the limit : 750",Toast.LENGTH_LONG).show();
            }
            else{
                Intent billing = new Intent(n1.this,customer_billing.class);
                ...
                billing.putExtra("pricelimit",String.valueOf(750));
