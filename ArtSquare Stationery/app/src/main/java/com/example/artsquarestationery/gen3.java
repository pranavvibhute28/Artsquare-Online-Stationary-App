...
public class gen3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemname = findViewById(R.id.itemname14);
        cost = findViewById(R.id.cost14);
    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userprofile!=null){
                    ...
                    FirebaseDatabase.getInstance().getReference("Favourites")
                            .child("n").setValue(fav);
                    Toast.makeText(gen3.this,"Item Added to Favourites Successfully",Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(gen3.this, "Something went Wrong..", Toast.LENGTH_LONG).show();
            }
        });
    }

    public void buygen3(View view) {
        ...
        if(q!=0){
            ...
            if(totalprice<1000){
                ...
                Intent billing = new Intent(gen3.this,customer_billing.class);
