...
public class gen5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemname = findViewById(R.id.itemname16);
        cost = findViewById(R.id.cost16);
    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userprofile!=null){
                    ...
                    FirebaseDatabase.getInstance().getReference("Favourites")
                            .child("p").setValue(fav);
                    Toast.makeText(gen5.this,"Item Added to Favourites Successfully",Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(gen5.this, "Something went Wrong..", Toast.LENGTH_LONG).show();
            }
        });
    }

    public void buygen5(View view) {
        ...
        if(q!=0){
            ...
            if(totalprice<150){
                Toast.makeText(this,"Total cost should be more than the limit : 150",Toast.LENGTH_LONG).show();
            }
            else{
                Intent billing = new Intent(gen5.this,customer_billing.class);
                ...
                billing.putExtra("pricelimit",String.valueOf(150));
