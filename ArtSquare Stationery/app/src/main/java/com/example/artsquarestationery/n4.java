...
public class n4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemname = findViewById(R.id.itemname20);
        cost = findViewById(R.id.cost20);
    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userprofile!=null){
                    ...
                    FirebaseDatabase.getInstance().getReference("Favourites")
                            .child("t").setValue(fav);
                    Toast.makeText(n4.this,"Item Added to Favourites Successfully",Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(n4.this, "Something went Wrong..", Toast.LENGTH_LONG).show();
            }
        });
    }

    public void buyn4(View view) {
        ...
        if(q!=0){
            ...
            if(totalprice<1000){
                ...
                Intent billing = new Intent(n4.this,customer_billing.class);
