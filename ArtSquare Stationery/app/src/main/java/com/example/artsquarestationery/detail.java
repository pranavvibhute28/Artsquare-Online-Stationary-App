...
public class detail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemname = findViewById(R.id.itemname6);
    ...
    public void buy1(View view) {
        Intent intent = new Intent(this,customer_billing.class);
        startActivity(intent);
    }

    public void favdetail(View view) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userprofile!=null){
                    ...
                    FirebaseDatabase.getInstance().getReference("Favourites")
                            .child("b").setValue(fav);
                    Toast.makeText(detail.this,"Item Added to Favourites Successfully",Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(detail.this, "Something went Wrong..", Toast.LENGTH_LONG).show();
            }
        });
    }

    public void buywpad(View view) {
        ...
        if(q!=0){
            ...
            if(totalprice<800){
                Toast.makeText(this,"Total cost should be more than the limit : 800",Toast.LENGTH_LONG).show();
            }
            else{
                Intent billing = new Intent(detail.this,customer_billing.class);
                ...
                billing.putExtra("pricelimit",String.valueOf(800));
