...
public class off1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemname = findViewById(R.id.itemname22);
        cost = findViewById(R.id.cost22);
    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userprofile!=null){
                    ...
                    FirebaseDatabase.getInstance().getReference("Favourites")
                            .child("v").setValue(fav);
                    Toast.makeText(off1.this,"Item Added to Favourites Successfully",Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(off1.this, "Something went Wrong..", Toast.LENGTH_LONG).show();
            }
        });
    }

    public void buyoff1(View view) {
        ...
        if(q!=0){
            ...
            if(totalprice<1000){
                ...
                Intent billing = new Intent(off1.this,customer_billing.class);
