...
public class off3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_off3);

        value=(TextView) findViewById(R.id.value);
        itemname = findViewById(R.id.itemname24);
        cost = findViewById(R.id.cost24);
    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userprofile!=null){
                    ...
                    FirebaseDatabase.getInstance().getReference("Favourites")
                            .child("x").setValue(fav);
                    Toast.makeText(off3.this,"Item Added to Favourites Successfully",Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(off3.this, "Something went Wrong..", Toast.LENGTH_LONG).show();
            }
        });
    }

    public void buyoff3(View view) {
        ...
        if(q!=0){
            ...
            if(totalprice<1500){
                ...
                Intent billing = new Intent(off3.this,customer_billing.class);
