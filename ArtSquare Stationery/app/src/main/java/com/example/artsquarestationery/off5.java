...
public class off5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_off5);

        value=(TextView) findViewById(R.id.value);
        itemname = findViewById(R.id.itemname26);
        cost = findViewById(R.id.cost26);
    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userprofile!=null){
                    ...
                    FirebaseDatabase.getInstance().getReference("Favourites")
                            .child("z").setValue(fav);
                    Toast.makeText(off5.this,"Item Added to Favourites Successfully",Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(off5.this, "Something went Wrong..", Toast.LENGTH_LONG).show();
            }
        });
    }

    public void buyoff5(View view) {
        ...
        if(q!=0){
            ...
            if(totalprice<1500){
                ...
                Intent billing = new Intent(off5.this,customer_billing.class);
