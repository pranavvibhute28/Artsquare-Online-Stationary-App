...
public class off4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_off4);

        value=(TextView) findViewById(R.id.value);
        itemname = findViewById(R.id.itemname25);
        cost = findViewById(R.id.cost25);
    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userprofile!=null){
                    ...
                    FirebaseDatabase.getInstance().getReference("Favourites")
                            .child("y").setValue(fav);
                    Toast.makeText(off4.this,"Item Added to Favourites Successfully",Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(off4.this, "Something went Wrong..", Toast.LENGTH_LONG).show();
            }
        });
    }

    public void buyoff4(View view) {
        ...
        if(q!=0){
            ...
            if(totalprice<1500){
                ...
                Intent billing = new Intent(off4.this,customer_billing.class);
